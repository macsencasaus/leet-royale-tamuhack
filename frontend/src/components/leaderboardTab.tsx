...
function LeaderboardTab() {
    ...
    function orderedPlayers(players: Record<number, PlayerStatus>): PlayerStatus[] {
        ...
        <div className="flex flex-col gap-2">
            {orderedPlayers(players).map((value, index) => (
                <div
                    ...
                    style={{
                        backgroundColor: value.finished ? "rgba(25, 135, 84, .5)" : undefined,
                    }}
                >
                    ...
                    <p>
                        <span className="font-bold">{value.casesCompleted}</span>/{totalCases}
                    </p>
                </div>
            ))}
        </div>
